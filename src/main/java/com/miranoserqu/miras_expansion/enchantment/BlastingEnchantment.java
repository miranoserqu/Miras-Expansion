...
public class BlastingEnchantment extends Enchantment {
    ...
    public static void onBlockBreak(BlockEvent.BreakEvent event){
        ...
        if(player.getMainHandItem().getEnchantmentLevel(ModEnchantments.BLASTING.get()) == 0) return;
        ...
        for(ItemStack itemStack : items){
            ...
            serverLevel.addFreshEntity(new ExperienceOrb(serverLevel, pos.getX(), pos.getY(), pos.getZ(), serverLevel.getRecipeManager().getRecipeFor(
